...
* **config:** add js-agent key pair to SM and server agent.toml ([db0cb71](https://github.com/OpenNHP/opennhp/commit/db0cb71034ab0270057f742476eb08357f17f041))
...
* **deploy:** front all three hosts with nginx + Let's Encrypt ([cb7291e](https://github.com/OpenNHP/opennhp/commit/cb7291e765e08df6dfd656019f5ce8911c0c84a6))
* **deploy:** host OpenNHP/js-agent demo at agent.opennhp.org ([5cf6184](https://github.com/OpenNHP/opennhp/commit/5cf6184822ef00300e24349ce8ceb27b6810ec02))
* **infra:** add Terraform demo stack and deploy workflows ([0a881b3](https://github.com/OpenNHP/opennhp/commit/0a881b3d30d2f188a0be466d0b475015d5d72e48))
...
* address PR 1502 review — secrets, lifecycle, relay correlation ([dd8a86d](https://github.com/OpenNHP/opennhp/commit/dd8a86dde94b2fc6819b8f162803114c4d5e668d))
...
* address security + reliability findings from review ([6547b3d](https://github.com/OpenNHP/opennhp/commit/6547b3d5f08f147e57457943142c104da93e9311))
...
* align AC id and make plugin resource dstIP deploy-time configurable ([85ac4c0](https://github.com/OpenNHP/opennhp/commit/85ac4c0de4e209926b1b4d1db1e5b21009144af3))
* apply AC firewall rules on deploy; redirect server root to login ([e5d66ac](https://github.com/OpenNHP/opennhp/commit/e5d66ac069fde1fd0a8809b286736b20ce7205c8))
...
* **ci:** fail fast on missing TF_STATE_BUCKET and unreachable relay ([616a3c8](https://github.com/OpenNHP/opennhp/commit/616a3c814d1a716f8b00170be942e0503cadc78a))
...
* **ci:** use github.event.inputs at job level instead of env context ([85c3a5c](https://github.com/OpenNHP/opennhp/commit/85c3a5c4d3f2de8a00a9f3232c85cfc1ce0cfcbb))
...
* **deploy-jsagent:** write SSH key via jq direct-to-file like other jobs ([985f91d](https://github.com/OpenNHP/opennhp/commit/985f91d18ecb4533b907bac83d4c0ed9022016cb))
...
* **deploy:** also install ipset on AC host ([523540b](https://github.com/OpenNHP/opennhp/commit/523540bc93dfd7232e936e2d4c2ae7080a0da233))
* **deploy:** extract JSON line only from keygen output ([a252649](https://github.com/OpenNHP/opennhp/commit/a2526493e28887b9893f988777977c2827937906))
...
* **deploy:** install certbot + cloudflare plugin via pip venv ([1709122](https://github.com/OpenNHP/opennhp/commit/1709122141177356fa7725d3d2d8813b3d42a37e))
* **deploy:** install iptables on AC host before starting nhp-acd ([b061a82](https://github.com/OpenNHP/opennhp/commit/b061a8210ecf62bbe2fa54ac8059bac879d2b3e7))
* **deploy:** recover from stale LE account and pre-create KBS dir ([897459b](https://github.com/OpenNHP/opennhp/commit/897459be5e8dec93f5012ae9f94f8018fca10482))
* **deploy:** redirect generate_keys log output to stderr ([9a3c82c](https://github.com/OpenNHP/opennhp/commit/9a3c82c0dd0855f330d5dd3fd11c3075ffcdbb9a))
...
* **login-page:** replace stale shodan link with dnschecker port scan ([5ce490e](https://github.com/OpenNHP/opennhp/commit/5ce490e9414965194655c5a837289f7fbfb8af70))
* **nginx:** rewrite '/' to login URL without changing visible path ([83fbe83](https://github.com/OpenNHP/opennhp/commit/83fbe83fcd3f932f6cfd8ac47b10bc8eaf963991))
...
* read NHP server host/asp/res from template context in login page ([59562e6](https://github.com/OpenNHP/opennhp/commit/59562e65658aa332ff5bcac8628aa71722085546))
...
* **relay:** trust X-Real-IP, not X-Forwarded-For, for client source IP ([91c4b18](https://github.com/OpenNHP/opennhp/commit/91c4b184d488a430f51e1f294d1a731175c56e24))
...
* **security:** address four findings from review (state, MITM, DoS, account ID) ([e2c5336](https://github.com/OpenNHP/opennhp/commit/e2c5336aa47a1a17c4e249f694fb9251b387cb12))
* **server-http:** tighten XFF defence and surface relay misconfig loudly ([ad98e1f](https://github.com/OpenNHP/opennhp/commit/ad98e1f436409b99ee722d0b362850c8492b4b25))
...
* **server:** make db.toml optional (match relay.toml behavior) ([50726ad](https://github.com/OpenNHP/opennhp/commit/50726ad8263f979697d34f5db3bdafb20c99aeb9))
...
* **terraform:** protect retired SSH-key resources from accidental destroy ([c15b80c](https://github.com/OpenNHP/opennhp/commit/c15b80c8e8b25a02f511db90ec6b4452db4320e5))
* **tf:** use aws:kms encryption for S3 backend state and locks ([0f012a0](https://github.com/OpenNHP/opennhp/commit/0f012a011783b558dfb5469483f5c4541eac6deb))
* **tf:** use correct secretsmanager data source names ([c84d730](https://github.com/OpenNHP/opennhp/commit/c84d7302837c15a1aba440cf6364168daff54468))
...
* **ci:** enable Go build cache in deploy-demo-v2 ([0eb1cf0](https://github.com/OpenNHP/opennhp/commit/0eb1cf00eb9b87b2f63c9c75bec27af185eac645))
